...
namespace Registration
{
    ...
    public class Order : EventSourced
    {
            ...
            : this(id)
        {
            ...
            var totals = pricingService.CalculateTotal(conferenceId, all.AsReadOnly()).Result;
        ...
        {
            var all = ConvertItems(items);
            var totals = pricingService.CalculateTotal(this.conferenceId, all.AsReadOnly()).Result;
